...
insert    into TutorialMessageText (messageFk, actorType, textType, content)
values    (322, 'JASMINE', 'COMMON', '{userName}님이라도 한가하시니 다행이에요');
...
insert    into TutorialMessageText (messageFk, actorType, textType, content)
values    (212, 'JASMINE', 'COMMON', '감사합니다 ㅎㅎ');
